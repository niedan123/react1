            ...
            <div>
                {
                    this.state.data.map((item,idx)=>(
                        <div style={{height:40,padding:10,float:"left",width:800}}>
                            ...
                            <span style={{marginTop:5,marginRight:5,background:"#80bd01",paddingLeft:2,paddingTop:4,color: "#fff",fontSize:12,float:"left"}}>精华</span>
                            <Link to={'/home/good:/'+`${page}`+'/'+`${idx}`} style={{width:500,paddingTop:5,float:"left",overflow:'hidden',whiteSpace:'nowrap', textOverflow:'ellipsis'}}>{item.title}</Link>
